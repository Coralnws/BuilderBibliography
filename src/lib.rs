// src/lib.rs
/*
 * Core library for BuilderBibliography
 */
...
#[derive(Debug)]
pub struct BuilderBibliographyProcessor {
    verbose: bool,
    processed_count: usize,
}

impl BuilderBibliographyProcessor {
...
pub fn run(verbose: bool, input: Option<String>, output: Option<String>) -> Result<()> {
    ...
    info!("Starting BuilderBibliography processing");
    
    let mut processor = BuilderBibliographyProcessor::new(verbose);
...
mod tests {
    ...
    fn test_processor_creation() {
        let processor = BuilderBibliographyProcessor::new(true);
    ...
    fn test_data_processing() {
        let mut processor = BuilderBibliographyProcessor::new(false);
